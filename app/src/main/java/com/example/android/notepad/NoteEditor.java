        ...
        if (mCursor != null) {
            ...
            switch (x){
                case NotePad.Notes.DEFAULT_COLOR:
                    mText.setBackgroundColor(Color.rgb(255, 250, 254));
                    break;
                case NotePad.Notes.PURPLE_COLOR:
                    mText.setBackgroundColor(Color.rgb(255, 204, 255));
                    break;
                case NotePad.Notes.BLUE_COLOR:
                    mText.setBackgroundColor(Color.rgb(153, 204, 255));
                    break;
                case NotePad.Notes.GREEN_COLOR:
                    mText.setBackgroundColor(Color.rgb(153, 204, 153));
                    break;
                case NotePad.Notes.RED_COLOR:
                    mText.setBackgroundColor(Color.rgb(255, 204, 153));
                    break;
                default:
